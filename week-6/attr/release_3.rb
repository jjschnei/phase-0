...
# The other age method was removed.

# What was replaced?
# The other age method was removed and replaced with an attribute writer.  I assume the next release will replace the attribute reader and writer with an attr_accessor method.

# Is this code simpler than the last?
# It's easier to read and less repetitive.